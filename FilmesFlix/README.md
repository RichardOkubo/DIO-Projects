...
Projeto desenvolvido no módulo "MVVM e Clean Architecture" do Bootcamp Kotlin Everis da DIO. O App consiste em exibir uma lista de filmes, oriundas de uma API. 
